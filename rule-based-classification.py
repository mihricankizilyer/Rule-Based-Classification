...
agg_df[["SEGMENT","PRICE"]].groupby("SEGMENT").agg({"PRICE": ["mean","max","sum"]})
agg_df[["SEGMENT","PRICE"]].groupby("SEGMENT").get_group("C").agg({"PRICE": ["mean","max","sum"]})
